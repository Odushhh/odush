      ...
      <header className="lg:hidden md:hidden px-6 pt-4 sticky top-0 z-50 bg-[#181818]">
        <div className="flex justify-between items-center w-full">
          <a href="#" onClick={(e) => { e.preventDefault(); window.scrollTo({top: 0, behavior: 'smooth'}); }}>
            <p className="font-semibold text-base text-gray-400 leading-tight md:leading-tight lg:leading-tight xl:leading-tight">Adrian Oduma</p>
            ...
            <div  className="flex flex-col gap-0 justify-start items-start">
              ...
              <div className="hidden md:block lg:block lg:mb-6 md:mb-8 xl:mb-6 pt-0 mb-8">
                <a href='https://ctrlzs.studio/'>
                  <p className="font-semibold font-helvetica text-xl text-gray-400 leading-tight md:leading-tight lg:leading-tight xl:leading-tight">Adrian Oduma</p>
