      ...
      <div className="container py-12">
        <div className="mt-4 pt-8 border-t border-white/20">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6 sm:gap-0">
            <p className="text-xl text-center sm:text-left">© 2025-27 Adrian Oduma. All rights reserved.</p>

            <div className="flex flex-row justify-center sm:justify-end gap-8 text-white">          
