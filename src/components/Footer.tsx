...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-b from-[#FFFFFF] from-[2%] to-[#BCC8CF] to-[50%] text-white font-inter px-16">
      <div className="container py-12 px-80">
        <div className="mt-4 pt-8">

          {/* CTA */}
          <div className="pb-40 flex flex-col gap-4 justify-center items-center text-black/80 text-center">
            <ul className='space-y-3 text-xl font-semibold pb-12 font-inter text-gray-700'>
            ...
            <a href='https://cal.com/odumzeez/first15'>
              <button className='bg-gradient-to-b from-[#1A1A1A] to-[#0F3904] text-white px-8 py-3 rounded-md hover:bg-black transition duration-2'>
          ...
          <div className="flex flex-col border-t border-black/20 py-8 sm:flex-row sm:items-center sm:justify-between gap-6 sm:gap-0">
            <p className="text-black/60 text-base text-center sm:text-left">© 2025</p>

            <div className="flex flex-row items-center sm:justify-center gap-8 text-black/60 text-base ">    
              ...
              {/*}     
              <a href="https://www.figma.com/proto/8VG79gmkk2mOnLMC4mUYqa/Oduma's-Design-Work?page-id=0%3A1&node-id=1-1514&viewport=561%2C309%2C0.13&t=0x5gjSRIbAn9nxfW-1&scaling=scale-down&content-scaling=fixed" target="_blank" rel="noopener noreferrer" className="hover:opacity-75 transition-opacity">
